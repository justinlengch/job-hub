    ...
    try:
        ...
        return {
            ...
            "parsed_data": {
                ...
                "intent": job_info.intent.value
                if hasattr(job_info.intent, "value")
                else str(job_info.intent),
            },
        }
...
async def parse_email(
    request: EmailParseRequest, current_user_id: str = Depends(get_current_user)
):
    """
